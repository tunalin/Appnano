...
const styles = StyleSheet.create({
    ...
    touch: { backgroundColor: '#005aa9', marginHorizontal: 45, marginTop: 120, width: 326, height: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 7 },
    text2: { fontSize: 16, fontWeight: '500', color: '#fff' },
    box1: { width: 414, height: 554, backgroundColor: '#fff', position: 'absolute', top: 348, borderRadius: 20, borderWidth: 0.5 },
    huong: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, marginTop: 20 },
    box2: { borderRadius: 7, borderWidth: 1, borderColor: '#c2c2c2', width: 382, height: 59, alignItems: 'center', justifyContent: 'center', marginTop: 20, marginLeft: 20 },
    ...
    hop: { width: 382, height: 104, borderRadius: 7, borderWidth: 1, borderColor: '#c2c2c2', marginHorizontal: 20, justifyContent: 'flex-start', alignItems: 'center', paddingTop: 10, marginVertical: 40 },
    text6: { fontSize: 13, fontWeight: '400', color: '#000' },
    huong3: { position: 'absolute', backgroundColor: '#fff', marginLeft: 70, padding: 5, marginTop: 20 },
