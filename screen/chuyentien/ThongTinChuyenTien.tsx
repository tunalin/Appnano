...
const styles = StyleSheet.create({
    ...
    container: { width: 414, height: 896, },
    ...
    huong2: { marginLeft: 20, marginTop: 15 },
    text2: { fontSize: 16, fontWeight: '400', color: '#000' },
    huong3: { borderRadius: 7, borderWidth: 1, borderColor: '#c2c2c2', width: 382, height: 59, alignItems: 'center', justifyContent: 'center', marginTop: 15, marginLeft: 20 },
    ...
    hop: { width: 382, height: 128, borderRadius: 7, borderWidth: 1, borderColor: '#c2c2c2', marginHorizontal: 20, marginTop: 15 },
