...
const ChiTietSp = ({navigation}:any) => {
    return (
        <View style={styles.container}>
            <View style={styles.huong}>
                <TouchableOpacity onPress={() => navigation.navigate('Khodiem')}>
            ...
            <View style={styles.huong2}>
                <Image source={require('../../imgdetail/ncruachen.png')}
            ...
            <View style={styles.view}>
                <View style={{ width: 384, height: 45 }}>
                    <Text style={styles.text2}>Nước rửa chén sinh học True - Bio Natural Dishwashing Liquid</Text>
                </View>
                <View style={{ width: 99, height: 30 }}>
                    <Text style={styles.text3}>800,000đ</Text>
                </View>
...
const styles=StyleSheet.create({
    ...
    dau:{ justifyContent: 'center', alignItems: 'center', flex: 1 },
